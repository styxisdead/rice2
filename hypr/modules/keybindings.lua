local vars = require("modules/programs")

local mainMod = "SUPER" -- Sets "Windows" key as main modifier

-- Example binds, see https://wiki.hypr.land/Configuring/Basics/Binds/ for more
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(vars.terminal))
...
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd("mkdir -p ~/Pictures/Screenshots && grim ~/Pictures/Screenshots/$(date +'%Y-%m-%d_%H-%M-%S').png"))
...
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("~/.config/quickshell/spotify/toggle.sh"))
